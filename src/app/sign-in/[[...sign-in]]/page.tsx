      ...
      <div className="w-full lg:w-1/2 flex flex-col gap-4">
        ...
        <SignIn.Root>
          ...
          <SignIn.Step name="start">
            ...
            <SignIn.Action
              submit
              className="mt-2 text-sm underline w-72 text-conter text-iconBlue"
            >
              Continue
            </SignIn.Action>
          </SignIn.Step>
            ...
            <SignIn.Strategy name="password">
              ...
              <div className="flex flex-col gap-2">
                ...
                <SignIn.Action
                  ...
                  className="mt-2 text-sm underline w-72 text-conter"
                >
                  Forgot-password
                </SignIn.Action>
              </div>
          ...
          <div className="w-72 flex flex-col items-center gap-4">
            ...
            <span className="text-textGrayLigh">or</span>
            <div className="h-px bg-borderGray flex-grow"></div>
            <Link
              href="/sign-up"
